...
class MBank:
    ...
    def transit(self, amount):
        if amount <= self.__cash:
            if amount <= 100000:
                commission = amount * 0.03
            else:
                commission = 100 + amount * 0.012
            total_amount = amount + commission
            self.__cash -= total_amount
            return f'Транзакция успешно выполнена. Списано {total_amount} сом.'
        else:
            return f'Недостаточно средств на счету. Ваш баланс: {self.get__cash()}'


online = MBank('Aygul', 'Altynova')
# print(online.info())
# print(online.info())
# print(online.get__cash())
online.set__cash(10000)
print(online.get__cash())
online.shopping(11000)


# print(online.get__cash())
# online.set__cash(100000)
# # online.shopping(54000)
# print(online.transit(54000))

# online.set__cash(100000)
# print(online.shopping(10000), online.transit(10000))
# print(online.get__cash())
# online.shopping(50000)
# print(online.transit(50000))
